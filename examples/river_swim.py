...
class RiverSwim(object):
    ...
    Optimal value (for discount factor 0.99 and 6 states):
    [56687.649 58596.324 61205.489 64136.002 67272.301 70582.794]
    
    Optimal policy (for discount factor 0.99 and 6 states):
    [1 1 1 1 1 1]
    """
    ...
    def __init__(self, 
        ...
        self.rewards = np.zeros((self.ns, self.na, self.ns))
        self.transitions = np.zeros((self.ns, self.na, self.ns))
        
        # Create rewards
        self.rewards[0, 0, 0] = min_reward
        self.rewards[-1, 1, -1] = max_reward
